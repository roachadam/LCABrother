...
class PasswordResetTest extends TestCase
{
    ...
    const ROUTE_PASSWORD_EMAIL = 'password.email';  //Send email
    const ROUTE_PASSWORD_REQUEST = 'password.request'; //Show submit email page
    const ROUTE_PASSWORD_RESET = 'password.reset';      //Show reset password page
    const ROUTE_PASSWORD_RESET_SUBMIT = 'password.update';  //Changes the password
    const USER_ORIGINAL_PASSWORD = 'secret';                //Original Password
    ...
    public function testSubmitPasswordResetRequest()
    {
        ...
        Notification::assertSentTo($user, ResetPassword::class, function ($notification, $channels) use ($user) {
            ...
            $expected_subject = "Reset Password Notification";
            return $mail->subject === $expected_subject;
        });
    }
    ...
    public function testSubmitPasswordResetInvalidEmail()
    {
        ...
        $this
            ...
            ->post(route(
                self::ROUTE_PASSWORD_RESET_SUBMIT
            ), [
                'token' => $token,
                'email' => str_random(),
                'password' => $password,
