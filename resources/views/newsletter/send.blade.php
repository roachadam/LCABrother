...
@section('content')
    ...
    @else
        <p class="offset-1">Please create a newsletter before attempting to send one! </p>
        <a href="/newsletter/create" class="btn btn-primary offset-1">Create Newsletter</a>
    @endif
